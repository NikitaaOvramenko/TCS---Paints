...
export default function Gallery() {
  return (
    <>
      <div className="self-center home  bg-radial-[at_50%_100%] from-[rgba(140,28,49,1)] to-[rgba(12,12,26,1)] to-100% w-full min-h-screen flex flex-col items-center gap-8 ">
